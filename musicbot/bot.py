...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 7506394
        e.set_footer(text='sarisia/MusicBot ({})'.format(BOTVERSION), icon_url='https://i.imgur.com/GNN4aCy.jpg')
        e.set_author(name=self.user.name, url='https://github.com/sarisia/MusicBot', icon_url=self.user.avatar_url)
        return e
